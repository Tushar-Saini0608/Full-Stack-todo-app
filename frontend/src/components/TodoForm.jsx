...
// // const PRIORITIES = [
// //   { value: 'low', label: 'Low', color: 'text-sage-600' },
...
//               Task title <span className="text-red-400">*</span>
//             </label>
//             <input className="input-base text-base" type="text" placeholder="What needs to be done?"
//               value={form.title} onChange={set('title')} required autoFocus maxLength={200} />
//           </div>
//           <div>
//             <label className="block text-xs font-medium text-ink-500 mb-1.5 uppercase tracking-wide">Description</label>
//             <textarea className="input-base resize-none" rows={3} placeholder="Add more details..."
//               value={form.description} onChange={set('description')} maxLength={1000} />
//           </div>
//           <div className="grid grid-cols-2 gap-3">
//             <div>
//               <label className="block text-xs font-medium text-ink-500 mb-1.5 uppercase tracking-wide">Priority</label>
//               <select className="input-base" value={form.priority} onChange={set('priority')}>
//                 {PRIORITIES.map(p => <option key={p.value} value={p.value}>{p.label}</option>)}
//               </select>
//             </div>
//             <div>
//               <label className="block text-xs font-medium text-ink-500 mb-1.5 uppercase tracking-wide">Due date</label>
//               <input className="input-base" type="date" value={form.due_date} onChange={set('due_date')}
//                 min={new Date().toISOString().split('T')[0]} />
//             </div>
//           </div>
//           <div className="flex gap-2 pt-1">
//             <button type="button" onClick={onClose} className="btn-ghost flex-1 py-2.5 border border-ink-200">Cancel</button>
//             <button type="submit" disabled={loading || !form.title.trim()} className="btn-primary flex-1 py-2.5">
//               {loading
//                 ? <svg className="animate-spin h-4 w-4" viewBox="0 0 24 24" fill="none">
//                     <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/>
//                     <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"/>
