...
// //   high:   { badge: 'priority-high',   dot: 'bg-red-500',   label: 'High' },
// //   medium: { badge: 'priority-medium', dot: 'bg-amber-500', label: 'Med' },
// //   low:    { badge: 'priority-low',    dot: 'bg-sage-500',  label: 'Low' },
// // };
...
// //     if (!todo.dueDate || todo.completed) return 'text-ink-400';
...
// //   return (
// //     <div
// //       className={`group flex items-start gap-3 px-4 py-3.5 border-b border-ink-50 last:border-0 
...
// //         {/* Meta row */}
// //         {todo.dueDate && (
// //           <p className={`text-xs mt-1 flex items-center gap-1 ${getDueDateStyle()}`}>
...
// //                 ? `Overdue · ${format(new Date(todo.dueDate), 'MMM d')}`
...
//   const getDueDateStyle = () => {
//     if (!todo.due_date || todo.is_completed) return 'text-ink-400';
